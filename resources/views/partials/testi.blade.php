@php
    ...
    $featuredTestimonials = TestimonialData::featured(3);
@endphp
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-card">
                                        ...
                                        <div class="card-content">
                                            <div class="rating">
                                                <p>Rating</p><i class="fa-solid fa-star-sharp"></i> <span>{{ number_format($testimonial['rating'], 1) }}</span>
                                            </div>
                                            <div class="review">
                                                <p>&ldquo;{{ $testimonial['testimonial'] }}&rdquo;</p>
                                                <p class="small mt-2 mb-0 text-white"><strong>{{ $testimonial['name'] }}</strong></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
