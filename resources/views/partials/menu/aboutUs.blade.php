<div class="row p-3">
  ...
  <div class="col-lg-3 col-md-6 border-start border-1" style="border-color:rgba(102,0,63,.1)!important;">
      <img src="https://visawizer.com.au/wp-content/uploads/2022/01/ab-m.jpg" class="rounded-3" style="height: 210px;width: 100%;object-fit: cover;">
...
<div class="mega-footer-strip px-4 py-2 d-flex align-items-center justify-content-between flex-wrap gap-2">
  <span class="d-flex align-items-center gap-2" style="font-size:.76rem;color:#5a3347;">
    ...
    Clear, personalised guidance from consultation to submission
  </span>
  <div class="d-flex align-items-center gap-3">
    <a href="{{ url('#home-visa-pathways') }}" class="strip-link">
      <i class="fa-solid fa-magnifying-glass"></i>Home Visa Pathways
    </a> |
    <a href="{{ url('career-guidance') }}" class="strip-link">
      <i class="fa-regular fa-compass"></i>Career Guidance
    </a> |
    <a href="{{ url('contact-us') }}" class="strip-link">
