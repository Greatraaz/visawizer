...
<div class="row justify-content-between row-gap-md-5 row-gap-4 p-b-40">
    ...
    <div class="col-md-12">
        <div class="f-logos text-center">
            ...
            <a href="https://www.mara.gov.au/get-help-visa-subsite/FIles/consumer_guide_english.pdf" target="_blank"> <img src="{{ url('img/mia.png') }}"></a>
            <a href="https://www.mara.gov.au/get-help-visa-subsite/FIles/consumer_guide_english.pdf" target="_blank"> <img src="{{ url('img/qeac.png') }}"></a>
        </div>
    </div>
    <div class="col-md-3">
