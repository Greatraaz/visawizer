                  ...
                  <div class="visa-mega-row">
                    <div class="visa-mega-col">
                      <div class="visa-mega-section">
                        <h6 class="visa-mega-section-title">Education &amp; Planning</h6>
                        <ul class="visa-mega-links">
                          <li><a href="{{ url('education') }}"><span class="link-icon"></span>Education</a></li>
                          <li><a href="{{ url('professional-year-programs') }}"><span class="link-icon"></span>Professional Year Programs</a></li>
                          <li><a href="{{ url('admission') }}"><span class="link-icon"></span>Admission</a></li>
                          <li><a href="{{ url('popular-courses-australia') }}"><span class="link-icon"></span>Popular Courses Australia</a></li>
                          <li><a href="{{ url('career-guidance') }}"><span class="link-icon"></span>Career Guidance</a></li>
                        </ul>
                      </div>
                    </div>
                    <div class="visa-mega-col">
                      <div class="visa-mega-section">
                        <h6 class="visa-mega-section-title">Change &amp; Support Services</h6>
                        <ul class="visa-mega-links">
                          <li><a href="{{ url('change-of-course') }}"><span class="link-icon"></span>Change Of Course</a></li>
                          <li><a href="{{ url('change-of-college-university') }}"><span class="link-icon"></span>Change Of College / University</a></li>
                          <li><a href="{{ url('overseas-student-health-cover') }}"><span class="link-icon"></span>Overseas Student Health Cover (OSHC)</a></li>
                        </ul>
                      </div>
                      <div class="visa-mega-section">
                        <h6 class="visa-mega-section-title">Student Visas</h6>
                        <ul class="visa-mega-links">
                          <li><a href="{{ url('study-visas') }}"><span class="link-icon"></span>Study Visas (For International Students)</a></li>
                          <li><a href="{{ url('visa/student-visa-500') }}"><span class="link-icon"></span>Student Visa (Subclass 500)</a></li>
                          <li><a href="{{ url('visa/student-guardian-590') }}"><span class="link-icon"></span>Student Guardian Visa (Subclass 590)</a></li>
                          <li><a href="{{ url('visa/training-407') }}"><span class="link-icon"></span>Training Visa (Subclass 407)</a></li>
                        </ul>
                      </div>
                    </div>
                    <div class="visa-mega-col">
                      <div class="visa-mega-section">
                        <h6 class="visa-mega-section-title">Graduate Pathways</h6>
                        <ul class="visa-mega-links">
                          <li><a href="{{ url('visa/temporary-graduate-485') }}"><span class="link-icon"></span>Temporary Graduate Visa (Subclass 485)</a></li>
                          <li><a href="{{ url('visa/post-study-work-485') }}"><span class="link-icon"></span>Post Study Work Visa (Subclass 485)</a></li>
                        </ul>
                      </div>
                    </div>
                    <div class="visa-mega-col visa-mega-promo-col">
                      <div class="visa-promo-card">
                        <div class="promo-icon"><i class="fa-regular fa-graduation-cap"></i></div>
                        <h5>Start Your Australia Study Journey</h5>
                        <p>Explore courses, admissions, student visas, and post-study pathways with expert guidance.</p>
                        <div class="promo-actions">
                          <a href="{{ url('book-appointment') }}" class="promo-btn-primary"><i class="fa-regular fa-calendar-check"></i> Book Appointment</a>
                          <a href="{{ url('contact-us') }}" class="promo-btn-outline"><i class="fa-regular fa-message"></i> Contact Us</a>
                        </div>
                      </div>
                    </div>
                  </div>
