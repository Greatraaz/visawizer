...
<style type="text/css">
    ...
    .protection-page .protection-band-soft {
        background:
            ...
            url('{{ asset('assets/images/services/banner-3.webp') }}') center / cover;
        position: relative;
    }
...
<div class="protection-page">
    <section class="hero-section-5 study-s1-hero protection-hero protection-band-dark" style="background-image: url('{{ asset('assets/images/area/image-31.webp') }}');">
        <div class="container">
    ...
    <section class="protection-section-pad protection-band-light">
        <div class="container">
            <div class="study-section-head-center text-center protection-separated protection-separated-center" data-aos="fade-up">
                <div class="common-subtitle text-uppercase justify-content-center"><span>For complex situations</span></div>
        ...
        <div class="container">
            <div class="protection-review-shell">
                <div class="protection-review-card protection-separated protection-separated-dark" data-aos="fade-up">
                    ...
                    <div class="common-title text-start m-b-15"><h2>ART review guidance for eligible visa decisions</h2></div>
                ...
                <div class="row g-0 align-items-stretch">
                    <div class="col-lg-5">
                        <div class="protection-visa-image">
                            <img src="{{ asset('assets/images/services/image-21.webp') }}" alt="Protection visa guidance for asylum seekers in Australia">
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="protection-visa-copy protection-separated">
                            <div class="common-subtitle text-uppercase"><span>For genuine protection needs</span></div>
        ...
        <div class="container">
            <div class="protection-care-wrap">
                <div class="protection-separated protection-separated-dark" data-aos="fade-up">
                    <div class="common-subtitle text-uppercase"><span>Privacy and care first</span></div>
                    <div class="common-title text-start m-b-15"><h2>Complex immigration matters need trust, time, and confidentiality</h2></div>
        ...
        <div class="container">
            <div class="row row-gap-4 align-items-end">
                <div class="col-lg-7 protection-separated" data-aos="fade-up">
                    <div class="common-subtitle text-uppercase"><span>Evidence matters deeply</span></div>
                ...
                <div class="col-lg-5 protection-evidence-aside" data-aos="fade-up" data-aos-delay="120">
                    <div class="protection-evidence-mini-image">
                        <img src="{{ asset('assets/images/services/banner-3.webp') }}" alt="Evidence planning for protection and appeal matters">
                    </div>
    ...
    <section class="protection-section-pad protection-band-dark" id="how-visawizer-helps-complex-matters">
        <div class="container">
            <div class="study-section-head-center text-center protection-separated protection-separated-dark protection-separated-center" data-aos="fade-up">
                <div class="common-subtitle text-uppercase justify-content-center"><span>Structured support</span></div>
        ...
        <div class="container">
            <div class="protection-urgent-shell">
                <div class="protection-urgent-note protection-separated" data-aos="fade-up">
                    <div class="common-subtitle text-uppercase"><span>Timing can be critical</span></div>
                ...
                <div class="protection-urgent-aside" data-aos="fade-up" data-aos-delay="140">
                    <div class="protection-urgent-image">
                        <img src="{{ asset('assets/images/services/image-21.webp') }}" alt="Urgent visa review and protection guidance">
                    </div>
    ...
    <section class="protection-section-pad protection-band-light">
        <div class="container">
            <div class="study-section-head-center text-center protection-separated protection-separated-center" data-aos="fade-up">
                <div class="common-subtitle text-uppercase justify-content-center"><span>Calm, careful, confidential</span></div>
    ...
    @include('partials.commonCta', [
        'ctaBg' => asset('assets/images/area/image-31.webp'),
