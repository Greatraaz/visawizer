...
<section class="study-s4-process" id="how-visawizer-helps">
    <div class="container">
        <div class="section-top-9 text-center">
            <div class="text-uppercase justify-content-center" data-aos="fade-up">
                <span class="bg-p">Guided from start to next step</span></div>
            <div class="common-title mt-4 mb-3" data-aos="fade-up" data-aos-delay="100"><h2>Complete support for your study journey</h2></div>
            <div class="w-line m-auto"></div>
            <p class="study-s4-intro m-b-0 mx-auto mt-3" style="max-width:700px;" data-aos="fade-up" data-aos-delay="200">We help you move from confusion to a structured study and visa action plan.</p>
        </div>
