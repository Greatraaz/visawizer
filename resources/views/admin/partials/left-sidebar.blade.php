        ...
        <div id="sidebar-menu">
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{url('admin/dashboard/settings')}}">View Settings</a></li>
                        <li><a href="{{url('admin/dashboard/banners')}}">Home Banner</a></li>
                        <li><a href="{{url('admin/dashboard/testimonials')}}">Testimonials</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="{{url('admin/resources')}}">Download Resources</a></li>
                    </ul>
                </li>
