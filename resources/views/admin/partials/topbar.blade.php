        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="navbar-brand-box">
                    <a href="{{url('admin/dashboard')}}" class="logo logo-light" style="padding-top: 25px;">
                        <span class="logo-lg">
                            <img src="{{ asset('assets/images/logo.png') }}" style="width: 63%;background: #fff;object-fit: contain;padding: 15px 10px;border-radius: 10px;">
                        </span>
                    </a>
                </div>
