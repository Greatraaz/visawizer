                                ...
                                <table id="datatable-buttons" class="table table-vertical-middle table-selectable">
                                    ...
                                    @foreach ($whitePaper as $node)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript:void(0)" onclick="editItem({{ $node->id }}, 'edit-white-paper')" class="btn btn-sm btn-success"><i class="fas fa-edit"></i></a>
                                                <a href="{{ url('admin/delete-white-paper/' . encrypt($node->id)) }}" onclick="return confirm('Are you sure?')" class="delete btn btn-primary btn-sm"><i class="fas fa-trash-alt"></i></a>
                                            </td>
                                        </tr>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="add-form mt-4" action="{{ url('admin/store-white-paper') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="row">
