...
@php
    $hero = $page['hero'];
    $heroImage = asset($page['heroImage'] ?? 'assets/images/area/image-31.webp');
    $isProtectionMatter = ($page['slug'] ?? '') === 'protection-visa-866';
    $matterImages = array_merge([
        'situations' => 'assets/images/services/banner-3.webp',
        'checklist' => 'assets/images/services/image-43.webp',
        'documents' => 'assets/images/services/banner-1.webp',
        'mistakes' => 'assets/images/services/image-52.webp',
        'process' => 'assets/images/services/big6.webp',
    ], $page['images'] ?? []);
@endphp
