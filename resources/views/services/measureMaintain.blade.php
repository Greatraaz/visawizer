...
<section class="hero-section-5" style="background-image: url({{ asset('assets/images/services/banner-5.webp') }});padding-top: 120px;">
    <div class="container">
                ...
                <div class="col-xl-7">
                    <div class="rightArea">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6">
                                <img src="{{ asset('assets/images/services/side5.webp') }}" alt="Ethics Training Workshop">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="row row-gap-4" data-aos="fade-up" data-aos-delay="600" data-aos-duration="1000">
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="service-card-3">
                    <div class="service-top">
                        <h4>Corporate<br>Ethics Training</h4>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="service-card-3">
                    <div class="service-top">
                        <h4>Leadership<br>Mentoring</h4>
                        <i class="fa-light fa-chess-king"></i>
                    </div>
                    <div class="service-content">
                        <p>Our guided mentoring programs to cultivate integrity-focused leadership at all levels.</p>
                    </div>
                    <div class="i-shape">
                        <h1>02</h1>
                    </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="service-card-3">
                    <div class="service-top">
                        <h4>Whistleblower<br>Awareness</h4>
        ...
        <div class="row row-gap-5 align-items-center">
            <div class="col-xl-6">
                <div class="thumb px-xl-5 left" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                    <div class="thumb-1">
                        <img src="{{ asset('assets/images/services/image-51.webp') }}">
                        
                    </div>
                    <div class="thumb-2"><img src="{{ asset('assets/images/services/image-52.webp') }}"></div>
                    <div class="thumb-3">
                        <div class="shape-wrapped-thumb"><img src="{{ asset('assets/images/services/image-53.webp') }}"></div>
                    </div>
                </div>
            </div>
            <div class="col-xl-6">
...
<section class="about-us-section-2 p-t-100 p-t-xs-80">
    <div class="container">
        <div class="section-top-5">
            ...
            <div class="right" data-aos="fade-up" data-aos-delay="600" data-aos-duration="1000">
                ...
                <p>Our workshops, coaching sessions, and certificate programs equip individuals and organizations with actionable knowledge to foster integrity, compliance, and sustainable ethical practices. Each program is carefully curated to ensure measurable impact on professional conduct and organizational culture.</p>
            </div>
        </div>
        <div class="thumb">
            <img alt="training-thumb" src="{{ asset('assets/images/services/big5.webp') }}">
    ...
    <section class="donate-to-us-section" style="background-image: url({{ asset('assets/images/services/last5.webp') }})">
    <div class="container">
