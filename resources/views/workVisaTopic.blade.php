...
.work-visa-topic-page .wvt-suit-planning-stack--planning-only .wvt-planning-copy__eyebrow {
    ...
    .work-visa-topic-page .wvt-pair-col--strategy .wvt-strategy-card__num {
        ...
        align-items: center;
        justify-content: center;
        background: linear-gradient(145deg, #d3007a, var(--theme-color-3));
        color: #fff !important;
        font-size: 0.8rem;
        font-weight: 700;
    ...
    .work-visa-topic-page .wvt-pair-col--challenges .wvt-challenge-card {
        ...
        border-left: 4px solid var(--theme-color-3) !important;
    ...
    /* Challenges block: heading + 2-col checklist, aligned padding throughout */
    .family-visa-topic-page .wvt-reality-standalone:not(.wvt-section-strategy-points) .wvt-pair-col--challenges {
        display: flex;
        flex-direction: column;
        align-items: stretch;
        padding: clamp(28px, 3vw, 44px) clamp(24px, 3.5vw, 48px) !important;
    }
    .family-visa-topic-page .wvt-reality-standalone:not(.wvt-section-strategy-points) .wvt-reality-head--family {
        width: 100%;
        max-width: none;
        margin: 0 !important;
    ...
    .family-visa-topic-page .wvt-reality-standalone:not(.wvt-section-strategy-points) .wvt-reality-head--family .wvt-heading {
        padding: 0;
        margin: 0;
        color: #111827;
        text-align: left !important;
    ...
    .family-visa-topic-page .wvt-reality-standalone:not(.wvt-section-strategy-points) .wvt-reality-head--family .wvt-reality-lead {
        padding: 12px 0 0;
        margin: 0;
        color: #475569;
        text-align: left !important;
    ...
    .family-visa-topic-page .wvt-reality-standalone:not(.wvt-section-strategy-points) .wvt-pair-col--challenges .wvt-challenge-grid {
        width: 100%;
        margin-top: 0 !important;
        padding: 0 !important;
        display: grid;
    ...
    .family-visa-topic-page .wvt-reality-standalone:not(.wvt-section-strategy-points) .wvt-challenge-card {
        ...
        background: #ffffff !important;
        border: 1px solid rgba(102, 0, 63, 0.1) !important;
        border-left: 4px solid #66003f !important;
        border-radius: 12px !important;
        box-shadow: 0 8px 24px rgba(15, 23, 42, 0.06) !important;
    }
    .family-visa-topic-page .wvt-reality-standalone:not(.wvt-section-strategy-points) .wvt-challenge-card > i {
        flex-shrink: 0;
        align-self: center;
        margin: 0 !important;
        width: 36px;
    ...
    .family-visa-topic-page .wvt-reality-standalone:not(.wvt-section-strategy-points) .wvt-challenge-card span {
        flex: 1;
        align-self: center;
        display: block;
        margin: 0;
                    ...
                    <div class="col-xl-11">
                        <div class="wvt-pair-col wvt-pair-col--challenges">
                            @if (!empty($page['challenges']['heading']) || !empty($page['challenges']['content']))
                                @if ($isFamilyVisaTopic)
                                    @include('partials.familyVisaChallengesHead', [
                                        'page' => $page,
                                        'headingId' => 'wvt-challenges-narrative-heading',
                                    ])
                                @else
                                    <div class="wvt-reality-head text-center text-lg-start mx-auto ms-lg-0 me-lg-0" data-aos="fade-up">
