...
<div class="visitor-page">
    <section class="hero-section-5 study-s1-hero visitor-hero visitor-band-dark" style="background-image: url('{{ asset('assets/images/services/banner-1.webp') }}');">
        <div class="container">
    ...
    <section class="visitor-section-pad visitor-band-light">
        <div class="container">
            <div class="study-section-head-center text-center visitor-separated visitor-separated-center" data-aos="fade-up">
                <div class="common-subtitle text-uppercase justify-content-center"><span>Choose your travel purpose</span></div>
            ...
            <div class="row row-gap-5 align-items-center">
                <div class="col-lg-5" data-aos="fade-up">
                    <div class="visitor-split-media">
                        <img src="{{ asset('assets/images/services/image-21.webp') }}" alt="Visitor visa guidance for Australia">
                    </div>
                </div>
        ...
        <div class="container">
            <div class="visitor-transit-wrap">
                <div class="visitor-separated" data-aos="fade-up">
                    ...
                    <div class="common-title text-start m-b-15"><h2>Transit visa guidance for smooth travel connections</h2></div>
                ...
                <div class="row g-0 align-items-stretch">
                    <div class="col-lg-5">
                        <div class="visitor-work-media">
                            <img src="{{ asset('assets/images/services/image-52.webp') }}" alt="Working holiday visa guidance for young travellers">
                        </div>
                    </div>
                    <div class="col-lg-7">
        ...
        <div class="container">
            <div class="visitor-audience-layout">
                <div class="visitor-image-card" data-aos="fade-up">
                    <img src="{{ asset('assets/images/services/big6.webp') }}" alt="Visitor visa support for travellers and families">
                </div>
                <div data-aos="fade-up" data-aos-delay="120">
                    <div class="visitor-separated">
                        <div class="common-subtitle text-uppercase"><span>For travellers and families</span></div>
                        <div class="common-title text-start m-b-15"><h2>Visitor visa support for different travel situations</h2></div>
    ...
    @include('partials.commonCta', [
        'ctaBg' => asset('assets/images/services/banner-1.webp'),
