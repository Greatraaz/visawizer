...
@php
    $pathways = [
        [
            ...
            'image' => 'assets/images/services/image-21.webp',
        ],
        [
            ...
            'image' => 'assets/images/services/banner-3.webp',
        ],
        [
            ...
            'image' => 'assets/images/services/image-52.webp',
        ],
        [
            ...
            'image' => 'assets/images/services/image-43.webp',
        ],
        [
            ...
            'url' => '#child-adoption-orphan-pathways',
            'image' => 'assets/images/area/image-31.webp',
        ],
    ];
...
<div class="family-page">
    <section class="hero-section-5 study-s1-hero family-hero family-band-dark" style="background-image: url('{{ asset('assets/images/services/banner-2.webp') }}');">
        <div class="container">
            ...
            <div class="row row-gap-5 align-items-center">
                <div class="col-lg-5" data-aos="fade-up">
                    <div class="family-split-media">
                        <img src="{{ asset('assets/images/services/image-43.webp') }}" alt="Partner visa support for couples">
                    </div>
                </div>
                <div class="col-lg-7" data-aos="fade-up" data-aos-delay="120">
                    <div class="family-split-card family-separated family-separated-dark">
                        <div class="common-subtitle text-uppercase"><span>For couples building life together</span></div>
                        <div class="common-title text-start m-b-15"><h2>Partner visa pathways for married, de facto, and engaged couples</h2></div>
            ...
            <div class="family-parent-wrap" data-aos="fade-up">
                <div class="row row-gap-4 align-items-center">
                    <div class="col-lg-6 family-separated">
                        <div class="common-subtitle text-uppercase"><span>Bring parents closer</span></div>
                    ...
                    <div class="col-lg-6">
                        <div class="family-inline-image">
                            <img src="{{ asset('assets/images/services/banner-3.webp') }}" alt="Parents and family reviewing Australian visa options">
                        </div>
    ...
    <section class="family-section-pad family-band-dark" id="child-adoption-orphan-pathways">
        <div class="container">
            ...
            <div class="family-image-strip" data-aos="fade-up" data-aos-delay="100">
                <img src="{{ asset('assets/images/services/image-52.webp') }}" alt="Child visa pathway planning">
                <img src="{{ asset('assets/images/services/side6.webp') }}" alt="Family care and child visa documents">
                <img src="{{ asset('assets/images/area/image-31.webp') }}" alt="Children joining family in Australia">
            </div>
                    ...
                    <div class="col-lg-5">
                        <div class="family-relative-note">
                            ...
                            <div class="family-relative-photo">
                                <img src="{{ asset('assets/images/services/image-21.webp') }}" alt="Relative visa guidance for care and support">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="family-section-pad family-band-dark" id="how-visawizer-helps-family">
        <div class="container">
            ...
            <div class="family-process-visual" data-aos="fade-up" data-aos-delay="100">
                <img src="{{ asset('assets/images/services/big6.webp') }}" alt="Structured family visa preparation process">
            </div>
        ...
        <div class="container">
            ...
            <div class="family-evidence-map" data-aos="fade-up" data-aos-delay="120">
                ...
                <div class="family-evidence-map__center">
                    <img src="{{ asset('assets/images/services/image-43.webp') }}" alt="Family visa evidence and document preparation">
        ...
        <div class="container">
            ...
            <div class="family-why-layout">
                <div class="family-why-visual" data-aos="fade-up" data-aos-delay="100">
                    <img src="{{ asset('assets/images/services/banner-2.webp') }}" alt="Families choosing careful visa guidance">
                </div>
    ...
    @include('partials.commonCta', [
        'ctaBg' => asset('assets/images/services/big6.webp'),
