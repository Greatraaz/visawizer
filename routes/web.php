...
use App\Http\Controllers\Admin\CaseStudyContriller;
...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::post('book-appointment', [AppointmentBookingController::class, 'store'])->name('book-appointment.store');
...
Route::get('case-study/{slug}', [HomeController::class, 'singleCaseStudy']);
...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'middleware' => 'admin'], function () {
  ...
  Route::get('edit-white-paper/{id}', [WhitePaperController::class, 'edit']);
  Route::post('store-white-paper', [WhitePaperController::class, 'store']);
  ...
  Route::get('case-study', [CaseStudyContriller::class, 'index']);
  Route::get('edit-case-study/{id}', [CaseStudyContriller::class, 'edit']);
  Route::post('store-case-study', [CaseStudyContriller::class, 'store']);
  Route::post('update-case-study', [CaseStudyContriller::class, 'update']);
  Route::get('delete-case-study/{id}', [CaseStudyContriller::class, 'delete']);

  Route::get('resources', [ResourcesController::class, 'index']);
  Route::get('edit-resources/{id}', [ResourcesController::class, 'edit']);
