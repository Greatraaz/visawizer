...
class HomeController extends Controller
{
    ...
    {
        $title = 'migration agency Melbourne | migration support services';
        $description = 'Get trusted support from a migration agency Melbourne with expert guidance from a certified Melbourne migration agent. Professional visa services for student, work, partner, PR, and business visas across Australia.';
