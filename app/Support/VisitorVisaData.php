...
class VisitorVisaData
{
    ...
    public static function pages(): array
    {
        ...
        foreach ($pages as &$page) {
            $folder = str_replace('visa/', '', $page['_key']);
            $page['images'] = self::visitorImages($folder);
        }
        unset($page);
    ...
    /**
     * Generated visitor visa topic images under public/assets/imgs/visitor/{folder}/.
     */
    private static function visitorImages(string $folder): array
    {
        $base = 'assets/imgs/visitor/' . $folder;

        return [
            'hero' => "{$base}/hero-bg.webp",
            'intro_suit' => "{$base}/intro-suit.webp",
            'profile' => "{$base}/profile.webp",
            'strategy' => "{$base}/strategy.webp",
            'support' => "{$base}/support.webp",
        ];
    }
