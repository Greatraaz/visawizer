...
class FamilyVisaData
{
    ...
    public static function pages(): array
    {
        ...
        foreach ($pages as &$page) {
            ...
            $page['images'] = self::familyImages($folder);
        }
        unset($page);
    ...
    /**
     * Generated family visa topic images under public/assets/imgs/family/{folder}/.
     */
    private static function familyImages(string $folder): array
    {
        $base = 'assets/imgs/family/' . $folder;
