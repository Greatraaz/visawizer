...
class ProtectionAppealData
{
    ...
    public static function pages(): array
    {
        $pages = [
            'visa/art-review-appeals' => [
                ...
                'heroImage' => 'assets/imgs/protection/art-review-appeals/hero.webp',
            ...
            'visa/protection-visa-866' => [
                ...
                'heroImage' => 'assets/imgs/protection/protection-visa-866/hero.webp',
        ...
        foreach ($pages as &$page) {
            $slug = $page['slug'];
            $page['images'] = self::matterImages($slug);
            $page['heroImage'] = $page['images']['hero'];
        }
        unset($page);
    ...
    /**
     * Generated protection matter images under public/assets/imgs/protection/{slug}/.
     */
    public static function matterImages(string $slug): array
    {
        $base = 'assets/imgs/protection/' . $slug;

        return [
            'hero' => "{$base}/hero.webp",
            'situations' => "{$base}/situations.webp",
            'checklist' => "{$base}/checklist.webp",
            'documents' => "{$base}/documents.webp",
            'mistakes' => "{$base}/mistakes.webp",
            'process' => "{$base}/process.webp",
        ];
    }
}
