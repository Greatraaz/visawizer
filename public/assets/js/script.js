...
(function ($) {
    ...
    /*--------------------------------------------------------------
    10b Google-style testimonial carousel (partials/testi)
    --------------------------------------------------------------*/
    document.querySelectorAll('.testi-google-slider').forEach(function (testiEl) {
        if (testiEl.swiper) {
            return;
        }
        var wrap = testiEl.closest('.testi-google-slider-wrap');
        var testiSlideCount = testiEl.querySelectorAll('.swiper-slide').length;
        if (!testiSlideCount) {
            return;
        }
        new Swiper(testiEl, {
            loop: testiSlideCount > 4,
            spaceBetween: 24,
            slidesPerView: 1.15,
            grabCursor: true,
            watchSlidesProgress: true,
            autoplay: testiSlideCount > 1 ? {
                delay: 4500,
                disableOnInteraction: false,
                pauseOnMouseEnter: true,
            } : false,
            navigation: {
                nextEl: wrap ? wrap.querySelector('.testi-google-button-next') : '.testi-google-button-next',
                prevEl: wrap ? wrap.querySelector('.testi-google-button-prev') : '.testi-google-button-prev',
            },
            breakpoints: {
                576: {
                    slidesPerView: Math.min(2, testiSlideCount),
                    spaceBetween: 20,
                },
                992: {
                    slidesPerView: Math.min(3, testiSlideCount),
                    spaceBetween: 24,
                },
                1200: {
                    slidesPerView: Math.min(4, testiSlideCount),
                    spaceBetween: 28,
                },
            },
        });
