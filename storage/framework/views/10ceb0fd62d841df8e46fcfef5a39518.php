  ...
  <div class="mega-inner">
    <div class="mega-grid">
      ...
      <div class="mega-col">
        ...
        <a href="<?php echo e(url('change-of-course')); ?>" class="mega-link">
          <i class="fa-solid fa-repeat link-icon"></i>
          <span>Change Of Course</span>
          <i class="fa-solid fa-arrow-right link-arrow"></i>
        </a>
        <a href="<?php echo e(url('change-of-college-university')); ?>" class="mega-link">
          <i class="fa-solid fa-building-columns link-icon"></i>
          <span>Change Of College / University</span>
          <i class="fa-solid fa-arrow-right link-arrow"></i>
        </a>
        <a href="<?php echo e(url('oshc')); ?>" class="mega-link">
      ...
      <div class="mega-col">
        ...
        <a href="<?php echo e(url('study-visas')); ?>" class="mega-link">
          <i class="fa-solid fa-earth-asia link-icon"></i>
          <span>Study Visas (International)</span>
          <i class="fa-solid fa-arrow-right link-arrow"></i>
        </a>
        <a href="<?php echo e(url('student-visa-subclass-500')); ?>" class="mega-link">
          <i class="fa-solid fa-id-card link-icon"></i>
          <span>Student Visa (Subclass 500)</span>
          <i class="fa-solid fa-arrow-right link-arrow"></i>
        </a>
        <a href="<?php echo e(url('student-guardian-visa-subclass-590')); ?>" class="mega-link">
          <i class="fa-solid fa-child link-icon"></i>
          <span>Student Guardian Visa (590)</span>
          <i class="fa-solid fa-arrow-right link-arrow"></i>
        </a>
        <a href="<?php echo e(url('training-visa-subclass-407')); ?>" class="mega-link">
      ...
      <div class="mega-col">
        ...
        <a href="<?php echo e(url('temporary-graduate-visa-subclass-485')); ?>" class="mega-link">
          <i class="fa-solid fa-clock-rotate-left link-icon"></i>
          <span>Temporary Graduate Visa (485)</span>
          <i class="fa-solid fa-arrow-right link-arrow"></i>
        </a>
        <a href="<?php echo e(url('post-study-work-visa-485')); ?>" class="mega-link">
      ...
      <div class="featured-panel">
        <div>
          <div class="featured-img-wrap">
            <img src="<?php echo e(asset('img/map.png')); ?>" alt="Students studying in Australia">
        ...
        <div class="featured-ctas">
          <a href="<?php echo e(url('book-appointment')); ?>" class="btn-gold">
    ...
    <div class="mega-footer">
      ...
      <div class="ms-auto">
        <a href="<?php echo e(url('study')); ?>" style="color:#fff;font-size:0.75rem;text-decoration:none;font-weight:600;display:flex;align-items:center;gap:6px;">
...
</div><?php /**PATH F:\xampp\htdocs\visawizer\resources\views/partials/menu/studyInAus.blade.php ENDPATH**/ ?>