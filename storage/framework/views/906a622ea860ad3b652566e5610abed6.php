    ...
    <div class="container">
        <div class="testi-google-head" data-aos="fade-up">
            ...
            <div class="testi-google-intro">
                <p><?php echo e($testiIntroP1); ?></p>
                <p><?php echo e($testiIntroP2); ?></p>
            </div>
        </div>
                        ...
                        <div class="swiper-slide">
                            <article class="testi-google-card">
                                <div class="testi-google-card__avatar-wrap">
                                    <?php if($avatarType === 'initial'): ?>
                                        <div
                                            class="testi-google-card__avatar-ring testi-google-card__avatar-ring--initial"
                                            style="background-color: <?php echo e($item['initial_bg'] ?? 'var(--theme-color-3)'); ?>;"
                                        >
                                            <span class="testi-google-card__avatar--initials" aria-hidden="true"><?php echo e($item['initial'] ?? mb_substr($name, 0, 1)); ?></span>
                                        </div>
                                    <?php elseif($avatarType === 'brand'): ?>
                                        <div class="testi-google-card__avatar-ring testi-google-card__avatar-ring--brand">
                                            <img
                                                src="<?php echo e(asset($item['image'] ?? 'assets/images/visawizer_logo.svg')); ?>"
                                                alt="Visawizer"
                                                width="88"
                                                height="88"
                                                loading="lazy"
                                ...
                                <h3 class="testi-google-card__name"><?php echo e($name); ?></h3>
                                ...
                                <div class="testi-google-card__text-wrap">
                                    <p class="testi-google-card__text is-collapsed" data-testi-text><?php echo e($item['testimonial'] ?? ''); ?></p>
                                </div>
        ...
        <div class="testi-google-cta text-center mt-5">
            <a class="e-primary-btn has-icon" href="<?php echo e(url('testimonials')); ?>">Read More Success Stories
...
<?php /**PATH F:\xampp\htdocs\visawizer\resources\views/partials/testi.blade.php ENDPATH**/ ?>