...
<?php if (! $__env->hasRenderedOnce('8c0ddf56-a708-4e0f-b547-fe76a21bc735')): $__env->markAsRenderedOnce('8c0ddf56-a708-4e0f-b547-fe76a21bc735'); ?>
<style type="text/css">
...
<section class="donate-to-us-section study-s8-banner common-cta-banner" style="background-image: url('<?php echo e($ctaBg); ?>');">
    <div class="container">
        <div class="donate-to-us-layout">
            <div class="become-volunteer-card mb-0" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                ...
                <div class="common-subtitle text-uppercase justify-content-center m-b-10"><span><?php echo e($ctaEyebrow); ?></span></div>
                <h2><?php echo e($ctaHeading); ?></h2>
                <div class="w-line m-auto"></div>
                <p class="study-s8-lead pt-3"><?php echo e($ctaLead); ?></p>
                <div class="study-final-actions">
                    <a class="e-primary-btn has-icon" href="<?php echo e($ctaPrimaryUrl); ?>">
                        <?php echo e($ctaPrimaryLabel); ?>

                        <span class="icon-wrap"><span class="icon"><i class="fa-regular fa-arrow-right"></i> <i class="fa-regular fa-arrow-right"></i></span></span>
                    </a>
                    <a class="study-btn-ghost-dark is-on-dark" href="<?php echo e($ctaSecondaryUrl); ?>"><?php echo e($ctaSecondaryLabel); ?></a>
                </div>
            </div>
        </div>
    </div>
</section>
<?php /**PATH F:\xampp\htdocs\visawizer\resources\views/partials/commonCta.blade.php ENDPATH**/ ?>