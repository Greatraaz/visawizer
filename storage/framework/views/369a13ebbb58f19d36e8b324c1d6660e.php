...
<script src="<?php echo e(asset('assets/admin/libs/peity/jquery.peity.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/admin/libs/chartist/chartist.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('assets/admin/libs/table-edits/build/table-edits.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/admin/js/pages/table-editable.init.js')); ?>"></script> 
<script src="<?php echo e(asset('assets/admin/js/raj_custom.js')); ?>"></script>
...
<script>
    ...
    function editItem(id, url) {
        ...
        let fullUrl = "<?php echo e(url('admin')); ?>/" + url + "/" + id;
...
<?php echo $__env->yieldPushContent('script'); ?>
        ...
        <?php /**PATH F:\xampp\htdocs\visawizer\resources\views/admin/partials/script.blade.php ENDPATH**/ ?>