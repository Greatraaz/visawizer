<?php $__env->startPush('css'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/visa-guide.css')); ?>">
<?php $__env->stopPush(); ?>
          ...
          <div class="vw-hero-grid">
            <div>
              ...
              <div class="vw-btn-row">
                <a class="vw-btn vw-btn-primary" href="<?php echo e(url('book-appointment')); ?>">Book a Visa Consultation</a>
    ...
    <section class="vw-section vw-section-small vw-section--under-hero vw-section--alt-light">
      <div class="vw-container vw-intro-grid">
        ...
        <figure class="vw-intro-photo">
          <img
            src="<?php echo e(asset('assets/imgs/study/study-visas/section4.webp')); ?>"
      ...
      <div class="vw-container">
        ...
        <div class="vw-card-grid">
          <article class="vw-guide-card" id="study-visa">
            ...
            <a class="vw-link" href="<?php echo e(route('study.index')); ?>">View Study Visa Guide →</a>
          </article>
          ...
          <article class="vw-guide-card" id="visitor-visa">
            ...
            <a class="vw-link" href="<?php echo e(route('visitor-short-stay.index')); ?>">View Visitor Visa Guide →</a>
          </article>
          ...
          <article class="vw-guide-card" id="skilled-visa">
            ...
            <a class="vw-link" href="<?php echo e(route('work-skilled-migration.index')); ?>">View Skilled Visa Guide →</a>
          </article>
          ...
          <article class="vw-guide-card" id="employer-sponsored">
            ...
            <a class="vw-link" href="<?php echo e(route('work-skilled-migration.index')); ?>">View Employer Visa Guide →</a>
          </article>
          ...
          <article class="vw-guide-card" id="family-visa">
            ...
            <a class="vw-link" href="<?php echo e(route('family-visas.index')); ?>">View Family Visa Guide →</a>
          </article>
          ...
          <article class="vw-guide-card" id="appeals">
            ...
            <a class="vw-link" href="<?php echo e(route('protection-appeals-humanitarian.index')); ?>">View Complex Case Guide →</a>
          </article>
        </div>
      </div>
    </section>
        ...
        <div class="vw-decision-layout">
          <div class="vw-decision-left">
            <figure class="vw-decision-photo">
              <img
                src="<?php echo e(asset('assets/imgs/study/study-visas/hero-band.webp')); ?>"
            ...
            <aside class="vw-decision-aside" aria-label="Pathway assessment call to action">
              <div class="vw-decision-aside-card">
                ...
                <a class="vw-btn vw-btn-primary vw-decision-aside-btn" href="<?php echo e(url('book-appointment')); ?>">Get Pathway Assessment</a>
              </div>
            </aside>
          </div>
      ...
      <div class="vw-container">
        <div class="vw-checklist-wrap">
          <div class="vw-checklist-copy">
            ...
            <div class="vw-btn-row">
              <a class="vw-btn vw-btn-primary vw-checklist-btn" href="<?php echo e(url('contact-us')); ?>">Request Document Guidance</a>
            </div>
          </div>
      ...
      <div class="vw-container">
        ...
        <div class="vw-why-layout">
          <figure class="vw-why-photo">
            <img
              src="<?php echo e(asset('assets/imgs/study/study-visas/final-bg.webp')); ?>"
      ...
      <div class="vw-container">
        ...
        <div class="vw-resource-grid">
          <article class="vw-resource-card">
            ...
            <a class="vw-link" href="<?php echo e(route('blogs.index')); ?>">Read Guide →</a>
          </article>
          <article class="vw-resource-card">
            <div>
      ...
      <div class="vw-container">
        <div class="vw-faq-grid">
          <div class="vw-faq-intro">
            ...
            <div class="vw-btn-row">
              <a class="vw-btn vw-btn-primary" href="<?php echo e(route('faq')); ?>">View All FAQs</a>
            </div>
            <figure class="vw-faq-photo">
              <img
                src="<?php echo e(asset('assets/imgs/study/study-visas/sidebar.webp')); ?>"
      ...
      <div class="vw-container">
        <div class="vw-final-cta-box">
          <div class="vw-final-cta-copy">
            ...
            <div class="vw-btn-row">
              <a class="vw-btn vw-btn-primary" href="<?php echo e(url('book-appointment')); ?>">Book Appointment</a>
              <a class="vw-btn vw-btn-secondary" href="tel:+61451951561">Call / SMS: 0451 951 561</a>
            </div>
          </div>
          <figure class="vw-final-cta-photo">
            <img
              src="<?php echo e(asset('assets/imgs/study/study-visas/hero-bg.webp')); ?>"
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\visawizer\resources\views/visa-guide-main.blade.php ENDPATH**/ ?>